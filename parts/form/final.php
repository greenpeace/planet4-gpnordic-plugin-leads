<div class="leads-form__final">
  ...
  <a class="button button--share" :href="completedAllAsks ? finalData.final_all_completed_button_url : finalData.final_incomplete_button_url" target="_blank" v-text="completedAllAsks ? finalData.final_all_completed_button_caption : finalData.final_incomplete_button_caption"></a>
  <?php 
