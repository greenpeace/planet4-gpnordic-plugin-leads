...
function get_form_settings()
{
    ...
    $form_settings
        ...
        ->addNumber('thank_you_share_go_to_step', ['instructions' => 'Step that the user is sent to if they want to share'])
        ->addText('thank_you_skip_button_caption', ['default_value' => 'No thank you'])
        ->addNumber('thank_you_skip_go_to_step', ['instructions' => 'Step that the user is sent to if they do NOT want to share'])
        ->addTab('share')
