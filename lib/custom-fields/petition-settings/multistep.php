...
function get_multistep_settings()
{
    ...
    $multistep_settings
        ...
        ->addMessage(
            ...
            'The settings below allow you to customize the thank you tab.<br/>Available variables (Headline and Description):<ul><li><code>${fname}</code> - signers first name</li><li><code>${counterCurrent}</code> - counter current value</li><li><code>${counterGoal}</code> - counter goal value</li></ul>',
            [
        ...
        ->addText('button_url', ['regex' => '/^(http|https|tel|mailto):\/\/[a-zA-Z0-9_.\';:@&=+$,%#\-\[\]]+$/'])
