...
class FormController
{
  ...
  {
     // Post Leads
    register_rest_route("window.location.pathname.split('/')[1]", "gplp/v1", '/leads', array(
      'methods' => 'POST',
      'permission_callback' => "__return_true",
      'callback' => __NAMESPACE__ . '\\FormController::set',
    ));
    register_rest_route("window.location.pathname.split('/')[1]", "gplp/v1", '/leads/count/(?P<source_code>.{1,})', array(
      'methods' => 'GET',
      'permission_callback' => "__return_true",
